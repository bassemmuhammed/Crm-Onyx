        ...
        <div onClick={e=>e.stopPropagation()} style={{
          ...
          <div style={{ padding:"10px 16px 20px", flexShrink:0, borderTop:`1px solid ${C.border}`, background:C.card }}>
            ...
            <div style={{ display:"flex", gap:7, marginBottom:8 }}>
              <a href={`tel:${local.phone}`} onClick={e=>e.stopPropagation()} style={{
                flex:1, display:"flex", alignItems:"center", justifyContent:"center", gap:6,
                padding:"10px 0", borderRadius:10, cursor:"pointer",
                border:`1px solid #10b98144`, background:`#10b98112`, color:"#10b981",
                fontFamily:"Archivo,sans-serif", fontSize:".72rem", fontWeight:800,
                textDecoration:"none",
              }}>
                <svg width="13" height="13" viewBox="0 0 256 256" fill="currentColor"><path d="M222.37,158.46l-47.11-21.11-.13-.06a16,16,0,0,0-15.17,1.4,8.12,8.12,0,0,0-.75.56L134.87,160c-15.42-7.49-31.34-23.29-38.83-38.51l20.78-24.71c.2-.25.39-.5.57-.77a16,16,0,0,0,1.32-15.06l-21.1-47.2a16,16,0,0,0-16.62-9.52A56.26,56.26,0,0,0,32,80c0,79.4,64.6,144,144,144a56.26,56.26,0,0,0,55.88-48.92A16,16,0,0,0,222.37,158.46Z"/></svg>
                اتصال
              </a>
              <a href={`https://wa.me/${(local.phone||"").replace(/\D/g,"")}`} target="_blank" rel="noopener noreferrer" onClick={e=>e.stopPropagation()} style={{
                flex:1, display:"flex", alignItems:"center", justifyContent:"center", gap:6,
                padding:"10px 0", borderRadius:10, cursor:"pointer",
                border:`1px solid #25d36644`, background:`#25d36612`, color:"#25d366",
                fontFamily:"Archivo,sans-serif", fontSize:".72rem", fontWeight:800,
                textDecoration:"none",
              }}>
                <svg width="13" height="13" viewBox="0 0 256 256" fill="currentColor"><path d="M187.58,144.84l-32-16a8,8,0,0,0-8,.5l-14.69,9.8a40.55,40.55,0,0,1-16-16l9.8-14.69a8,8,0,0,0,.5-8l-16-32A8,8,0,0,0,104,64a40,40,0,0,0-40,40,88.1,88.1,0,0,0,88,88,40,40,0,0,0,40-40A8,8,0,0,0,187.58,144.84ZM152,176a72.08,72.08,0,0,1-72-72,24,24,0,0,1,19.29-23.54l11.48,22.94L101,117.11a8,8,0,0,0-.73,7.65,56.58,56.58,0,0,0,30.15,30.23,8,8,0,0,0,7.64-.87l14.24-9.5,22.87,11.43A24,24,0,0,1,152,176ZM128,24A104,104,0,0,0,36.18,176.88L24.83,210.93a16,16,0,0,0,20.24,20.24l34.05-11.35A104,104,0,1,0,128,24Zm0,192a88,88,0,0,1-43.06-11.27,8,8,0,0,0-6.54-.67L40,216l12.94-38.4a8,8,0,0,0-.67-6.54A88,88,0,1,1,128,216Z"/></svg>
                واتساب
              </a>
            </div>
    ...
    <div className="lead-card" onClick={onClick} style={{
      ...
      <div style={{ padding:"13px 14px" }}>
        ...
        <div style={{ display:"flex", alignItems:"center", gap:11, marginBottom: hasCallback ? 8 : 10 }}>
          ...
          {/* Status pill */}
          <div style={{ background:meta.bg, borderRadius:99, padding:"4px 10px", border:`1px solid ${meta.color}40`, flexShrink:0 }}>
            <span style={{ fontSize:".57rem", fontWeight:700, color:meta.color, fontFamily:"Archivo,sans-serif" }}>{meta.icon} {meta.label}</span>
          </div>
          ...
          <div style={{
            ...
            <svg width="10" height="10" viewBox="0 0 256 256" fill={C.gray}><path d="M221.66,133.66l-72,72a8,8,0,0,1-11.32-11.32L196.69,136H40a8,8,0,0,1,0-16H196.69L138.34,61.66a8,8,0,0,1,11.32-11.32l72,72A8,8,0,0,1,221.66,133.66Z"/></svg>
          </div>
        </div>
        ...
        {hasCallback && (
          <div style={{
            ...
            background:`#f59e0b14`, border:`1px solid #f59e0b28`,
            borderRadius:8, padding:"5px 10px", marginBottom:8,
          }}>
            <span style={{ fontSize:".6rem", fontWeight:800, color:"#f59e0b", fontFamily:"Archivo,sans-serif", display:"flex", alignItems:"center", gap:5 }}>
              <svg width="9" height="9" viewBox="0 0 256 256" fill="#f59e0b"><path d="M222.37,158.46l-47.11-21.11-.13-.06a16,16,0,0,0-15.17,1.4,8.12,8.12,0,0,0-.75.56L134.87,160c-15.42-7.49-31.34-23.29-38.83-38.51l20.78-24.71c.2-.25.39-.5.57-.77a16,16,0,0,0,1.32-15.06l-21.1-47.2a16,16,0,0,0-16.62-9.52A56.26,56.26,0,0,0,32,80c0,79.4,64.6,144,144,144a56.26,56.26,0,0,0,55.88-48.92A16,16,0,0,0,222.37,158.46Z"/></svg>
              CALL BACK
            </span>
            <span style={{ fontSize:".6rem", color:"#f59e0b", fontFamily:"Archivo,sans-serif" }}>
        ...
        <div style={{ display:"flex", alignItems:"center", gap:5, flexWrap:"wrap" }}>
          <div style={{ fontSize:".58rem", color:C.silver, fontWeight:600, background:C.cardAlt, padding:"3px 8px", borderRadius:6, border:`1px solid ${C.border}`, fontFamily:"Archivo,sans-serif", display:"flex", alignItems:"center", gap:3 }}>
            <svg width="8" height="8" viewBox="0 0 256 256" fill={C.gray}><path d="M240,208H224V96a16,16,0,0,0-16-16H144V48a16,16,0,0,0-24.77-13.38L39.23,82.62A16,16,0,0,0,32,96V208H16a8,8,0,0,0,0,16H240a8,8,0,0,0,0-16ZM208,96V208H144V96ZM48,96l80-48V208H48Z"/></svg>
            {lead.project}
          </div>
          {agent ? (
            <div style={{ fontSize:".58rem", color:agent.color, fontWeight:700, background:agent.color+"18", padding:"3px 8px", borderRadius:6, border:`1px solid ${agent.color}28`, fontFamily:"Archivo,sans-serif", display:"flex", alignItems:"center", gap:3 }}>
              <div style={{ width:10, height:10, borderRadius:3, background:agent.color, display:"flex", alignItems:"center", justifyContent:"center", fontSize:".36rem", fontWeight:900, color:"#fff" }}>{agent.name.charAt(0)}</div>
              {agent.name.split(" ")[0]}
            </div>
          ) : (
...
export default function AdminLeadsPage() {
  ...
  return (
    <div style={{
      ...
      {/* ── BODY ── */}
      <div style={{ padding:"12px 14px 24px", display:"flex", flexDirection:"column", gap:9 }}>
      ...
      <div onClick={() => setModal("fab")} className="tap-btn" style={{
        position:"fixed", bottom:28, right:"calc(50% - 215px + 16px)",
        width:58, height:58, borderRadius:"50%",
        background:C.red, boxShadow:`0 6px 24px ${C.red}66`,
        display:"flex", alignItems:"center", justifyContent:"center",
        cursor:"pointer", zIndex:40,
      }}>
        <svg width="24" height="24" viewBox="0 0 256 256" fill="#fff"><path d="M224,128a8,8,0,0,1-8,8H136v80a8,8,0,0,1-16,0V136H40a8,8,0,0,1,0-16h80V40a8,8,0,0,1,16,0v80h80A8,8,0,0,1,224,128Z"/></svg>
      </div>
    </div>
  );
}
